...
#: What the repository publishes, transcribed from the documents under audit. If a value
#: below disagrees with a recomputation, one of the two is wrong and this script says so.
PUBLISHED = {
    "auc_regret": {
...
def main() -> int:
    ...
    parser.add_argument("--run-dir", type=Path,
                        default=Path("results/runs/primary_pilot_2026-08-18"))
    ...
    print("paper follow from the chain results. It says nothing about whether the run")
    print("was valid -- it was not: FAILURE_LOG.md F-020 and F-021 record why, and the")
    print("primary contrast is reported as not established.")
    return 0
