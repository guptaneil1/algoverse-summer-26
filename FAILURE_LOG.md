...
| Scientific consequence | Material and positive. The project has a valid primary result for the first execution in which its own fairness constraint holds: a preregistered null with an interval inside the equivalence region, plus three admissible secondary contrasts that locate the effect -- spending helps 4.04%, targeting helps a further 9.59%, timing 0.41% with an interval containing zero |
