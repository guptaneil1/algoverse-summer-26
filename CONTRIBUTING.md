...
For the August 15 team workflow, named weekly branches, directory ownership,
integration gates, and commit/PR conventions, read
[`docs/WORKFLOW.md`](docs/WORKFLOW.md) and [`docs/TEAM.md`](docs/TEAM.md) first.

## Four-person deadline rule

Every weekly deliverable must be independently completable from the frozen
beginning-of-week tag and fixtures. Do not make another person's current branch
an undeclared dependency. Open a draft PR on the first day and target the weekly
